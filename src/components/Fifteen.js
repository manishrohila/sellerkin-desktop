...
const Fifteen = () => {
    return (
        <div className='bg-custom-color pt-10 pb-10'>
            <div className='xl:text-5xl md:text-2xl font-sans font-bold hidden md:flex justify-center gap-2 md:relative md:left-28 xl:static'>
                <p><span className='text-custom-color-1'>Imagine </span></p>
                <div className='flex flex-col gap-2 justify-center'>
                    <p> where you would be in...</p>
                    <img src={underline} alt="img loading" className='xl:w-10/12 md:w-6/12' />
                </div>
            </div>
            ...
            <div className=" md:flex hidden justify-center items-center  ">
                <div className='flex flex-col gap-4 border-2 bg-custom-color-2 rounded-lg shadow-lg p-10'>
                    ...
                    <div className='relative font-sans'>
                        ...
                        <p className='absolute font-semibold top-1 xl:left-10 text-white text-lg'>1 Week from Now:</p>
                    </div>
                    <div className='-mt-6 md:text-[10px] xl:text-base'>
                    ...
                    <div className='md:text-[10px] xl:text-base '>
                ...
                <div className='self-end '>
                    <img src={arrow} alt="img loading" className='relative  xl:bottom-28 md:w-16 md:bottom-10 xl:w-20' />
                </div>
                <div >
                    <img src={first} alt="img loading" className='w-72 xl:w-[490px] xl:h-[529px]' />
                </div>
            </div>
            <div className="mt-10 md:flex hidden justify-center items-center ">
                <div>
                    <img src={second} alt="img loading" className='w-72 xl:w-[490px]' />
                </div>
                <div className='self-end transform scale-x-[-1]'>
                    <img src={arrow} alt="" className='relative bottom-16 md:w-16 xl:w-20' />
                </div>
                <div className='flex flex-col gap-4 border-2 bg-custom-color-2 rounded-lg shadow-lg p-10'>
                    <div className='relative font-sans'>
                        <img src={box} alt="img loading" className='relative -left-16' />
            ...
            <div className="mt-10 md:flex hidden justify-center items-center ">
                <div className='flex flex-col gap-4 border-2 bg-custom-color-2 rounded-lg shadow-lg p-10'>
                    <div className='relative font-sans'>
                        <img src={box} alt="img loading" className='relative -left-16' />
                        <p className='absolute font-semibold top-1 xl:left-10 text-white text-lg'>6 Month from Now:</p>
                    </div>
                    <div className='-mt-6 md:text-[10px] xl:text-base'>
                ...
                <div className='self-end'>
                    <img src={arrow} alt="" className='relative  xl:bottom-24 md:w-16  xl:w-20 md:bottom-10' />
                </div>
                <div >
                    <img src={third} alt="img loading" className='w-72 xl:w-[491px]' />
                </div>
            </div>
