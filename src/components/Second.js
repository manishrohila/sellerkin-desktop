                ...
                <div className='flex  gap-10 justify-evenly font-serif'>
                    <div className='flex   flex-col'>
                        ...
                        <div className='flex flex-col gap-6 left-10 relative text-base mt-8 font-serif'>
                            ...
                            <div>
                                <p>However, There are <b>9.86 Million Sellers on Etsy</b>
                                </p>
                            </div>
                            <div>
                                <p>NOT everyone is successful <strong>(Too much Competition)</strong>  </p>
                            </div>
                            <div>
                    ...
                    <div>
                        <img className="ml-10 relative top-10" src={group84} alt="gdfg"></img>
                    </div>
                </div>
                ...
                <div className='flex  justify-evenly mt-10 font-serif'>
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <div>
                            ...
                            <p>thinking <strong>how others make more sales on
                                Etsy?</strong></p>
                        </div>
                        <div>
                            <p>Truth being told, there is a <b>Better Way</b> and let me</p>
