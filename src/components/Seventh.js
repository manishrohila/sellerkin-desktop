...
const Seventh = () => {
    return (
        <div className='bg-custom-color-2 mb-80 md:mb-0'>
            ...
            <div className="hidden md:flex md:flex-row justify-center mt-5 font-serif ">
                ...
                <div className="bg-custom-color-1 m-1 text-2xl  py-3 border-2 rounded-lg flex justify-center flex-col md:flex md:flex-col text-white mb-10 px-10 tracking-wider ">
                    ...
                    <p className=' text-base flex items-center justify-center'>Soon, Prices are going to be increased</p>
                </div>
                <div>
            ...
            <div className="flex flex-row  md:hidden justify-center mt-5 font-sans mb-10 ">
                ...
                <div className="bg-custom-color-1 m-1 text-base px-5 py-3 border-2 rounded-lg flex justify-center items-center flex-col text-white font-bold p">
            ...
            <div className='flex justify-center items-center -mt-5 mb-6'>
                <p className=''>No Download or installation Required</p>
            </div>
